<?php 
    ...
    and isset($_POST['first_name']) && $_POST['first_name'] !== ''
    and isset($_POST['last_name']) && $_POST['last_name'] !== ''
    and isset($_POST['password']) && $_POST['password'] !== ''
    and isset($_POST['confirm']) && $_POST['confirm'] !== ''){
        if($_POST['password'] === $_POST['confirm']){
            ...
            $error = 'کلمه عبور با تاییدیه کلمه عبور مغایرت دارد';
        }
        ...
        if($user === false){
            ...
            $error = 'ایمیل وارد شده تکراری می باشد';
        }
    }
    else{
        if(!empty($_POST)){
